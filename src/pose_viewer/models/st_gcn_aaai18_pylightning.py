...
from pore.models import Graph
from pore.models import ConvTemporalGraphical
...
class ST_GCN_18(LightningModule):
    ...
    def __init__(self,
        ...
        self.st_gcn_networks = nn.ModuleList((
            st_gcn_block(in_channels,
                         ...
                         residual=False,
                         **kwargs0),
            st_gcn_block(64, 64, kernel_size, 1, **kwargs), # remove to trim
            st_gcn_block(64, 64, kernel_size, 1, **kwargs),
            st_gcn_block(64, 64, kernel_size, 1, **kwargs), #remove to trim
            st_gcn_block(64, 128, kernel_size, 2, **kwargs),
            st_gcn_block(128, 128, kernel_size, 1, **kwargs),
            st_gcn_block(128, 128, kernel_size, 1, **kwargs),#remove to trim
            st_gcn_block(128, 256, kernel_size, 2, **kwargs),
            st_gcn_block(256, 256, kernel_size, 1, **kwargs),#remove to trim
    ...
    def setup(self, stage = None):
        ...
        if stage == "fit" or stage is None:
            ...
            self.pose_train, self.pose_val = random_split(self.train_data, [train_length, val_length], 
